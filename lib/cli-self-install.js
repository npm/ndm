...
CliSelfInstall.prototype.remove = function(serviceName) {
  CliBase.prototype.remove.call(this, this.serviceName);
};

CliSelfInstall.prototype.install = function(serviceName) {
