...
exports.allServices = function(serviceNameFilter) {
  ...
  if (!config.tmpServiceJsonPath && serviceJsonPath.indexOf('package.json') !== -1) return exports._parsePackageJson(serviceNameFilter, serviceJson);
  else return exports._parseServiceJson(serviceNameFilter, serviceJson);
};

// convert a package.json into a service.json format and parse it.
exports._parsePackageJson = function(serviceNameFilter, packageJson) {
  var serviceJson = {},
  ...
  return exports._parseServiceJson(serviceNameFilter, serviceJson);
}

// service.json files can be used to describe multiple
// services, they have a slightly different format than
// package.json.
exports._parseServiceJson = function(serviceNameFilter, serviceJson) {
  var services = [];
